...
def test_order_add_material(browser):
    ...
    message = "This order test3 currently belongs to campaign [CampaignMaterial]. Once you add materials, " \
              "it will be removed from the campaign {1}."
    ...
    browser.find_element(By.XPATH,
                         "//table[@class='Edit_Panel']/tbody/tr/td/table/tbody/tr[2]//button[text()='Cancel']").click()
    time.sleep(3)
    ...
    select_order.find_element(By.XPATH, "../td/img").click()
    time.sleep(3)
    cancel_sequences = browser.find_elements(By.XPATH, "//a[text()='Material']/../../../../../../../../../../../../tr"
                                                       "/td[@class='Inner_Column_Left'][1]")
    for cs in cancel_sequences:
        print(cs.text)
        assert cs.text in ["1", "2", "3"]
    # test2
    time.sleep(3)
    # 2.add material
    browser.find_element(By.XPATH, "//a[text()='Add a Material']").click()
    ...
    browser.find_element(By.XPATH, "//button[text()='Add Material']").click()
    time.sleep(3)
    assert "The selected material cannot be added again since it is the Main ingredient!" in BaseFun(browser).get_AlterMessage()
    time.sleep(3)
