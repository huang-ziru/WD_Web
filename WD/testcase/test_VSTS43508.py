...
def test_modify_booth(browser):
    ...
    browser.find_element(By.XPATH, "//select[@name='workstation']/option[3]").click()
    ...
    browser.find_element(By.XPATH, "//input[@name='cleanExpirePeriod']").send_keys("5000")
    browser.find_element(By.XPATH, "//input[@name='apiCleanExpirePeriod']").clear()
    browser.find_element(By.XPATH, "//input[@name='apiCleanExpirePeriod']").send_keys("1234")
    browser.find_element(By.XPATH, "//input[@name='excCleanExpirePeriod']").clear()
    browser.find_element(By.XPATH, "//input[@name='excCleanExpirePeriod']").send_keys("263")
    ...
    browser.find_element(By.XPATH, "//div[text()='User:']/../../td[5]/select[@class='gwt-ListBox Report_Cretiria_Combobox_Width']/option[text()='administrator(administrator)']").click()
    ...
    # assert report
    columns = ["User", "Booth"]
    dataTexts = ["administrator(administrator)", "booth1"]
